 ...
 */
 function loadSources<TSourceOptions, TSources extends UnknownSources<TSourceOptions>, TExclude extends string>(sources: TSources, sourceOptions: TSourceOptions, excludeSources: readonly TExclude[]): () => Promise<Omit<SourcesToComponents<TSources>, TExclude>>;
/**
 ...
 * This function is out of Semantic Versioning, i.e. can change unexpectedly. Usage is at your own risk.
 */
 function transformSource<TOptions, TValueBefore, TValueAfter>(source: Source<TOptions, TValueBefore>, transformValue: (value: TValueBefore) => TValueAfter): Source<TOptions, TValueAfter>;
 ...
 */
 ...
 function getFonts(): Promise<string[]>;
...
type PluginData = {
 ...
 function getPlugins(): PluginData[] | undefined;
 ...
 */
 function getTouchSupport(): TouchSupport;
 ...
 function getScreenResolution(): [number | null, number | null];
...
type FrameSize = [number | null, number | null, number | null, number | null];
 function getScreenFrame(): () => Promise<FrameSize>;
/**
 * Sometimes the available screen resolution changes a bit, e.g. 1900x1440 → 1900x1439. A possible reason: macOS Dock
 * shrinks to fit more icons when there is too little space. The rounding is used to mitigate the difference.
 */
 function getRoundedScreenFrame(): () => Promise<FrameSize>;

 function getHardwareConcurrency(): number | undefined;

 function getTimezone(): string;

 function getSessionStorage(): boolean;

 function getLocalStorage(): boolean;

 function getIndexedDB(): boolean | undefined;

 function getOpenDatabase(): boolean;

 function getCpuClass(): string | undefined;
 ...
 */
 function getDomBlockers({ debug }?: Options): Promise<string[] | undefined>;
 ...
 */
 function areColorsInverted(): boolean | undefined;

/**
 * @see https://developer.mozilla.org/en-US/docs/Web/CSS/@media/forced-colors
 */
 function areColorsForced(): boolean | undefined;
 ...
 */
 function getMonochromeDepth(): number | undefined;

/**
 * @see https://www.w3.org/TR/mediaqueries-5/#prefers-contrast
 * @see https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-contrast
 */
 function getContrastPreference(): number | undefined;

/**
 * @see https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-reduced-motion
 */
 function isMotionReduced(): boolean | undefined;

/**
 * @see https://www.w3.org/TR/mediaqueries-5/#dynamic-range
 */
 function isHDR(): boolean | undefined;
 ...
 */
 function getFontPreferences(): Promise<Record<string, number>>;
 ...
 */
 function getVideoCard(): VideoCard | undefined;

 function isPdfViewerEnabled(): boolean | undefined;
 ...
 */
 function load({ delayFallback, debug, monitoring }?: Readonly<LoadOptions>): Promise<Agent>;
 ...
 * This function is out of Semantic Versioning, i.e. can change unexpectedly. Usage is at your own risk.
 */
 function withIframe<T>(action: (iframe: HTMLIFrameElement, iWindow: Window) => MaybePromise<T>, initialHtml?: string, domPollInterval?: number): Promise<T>;
...
type fp = typeof FingerprintJs;
declare var FingerprintJS:fp